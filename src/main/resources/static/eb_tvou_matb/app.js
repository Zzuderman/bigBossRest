...
const userFetchService = {
    ...
    findOneUser: async (id) => await fetch(`rest/user/{id}`),
    addNewUser: async (user) => await fetch('rest/user', {method: 'POST', headers: userFetchService.head, body: JSON.stringify(user)}),
    updateUser: async (user, id) => await fetch(`rest/user`, {method: 'PUT', headers: userFetchService.head, body: JSON.stringify(user)}),
    deleteUser: async (id) => await fetch(`rest/user/{id}`, {method: 'DELETE', headers: userFetchService.head})
}

async function getTableWithUsers() {
    let table = jQuery('#mainTableWithUsers tbody');
    table.empty();
